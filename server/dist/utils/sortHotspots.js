 ...
 */
export function calcHotScore(item) {
 ...
 */
export function compareImportance(a, b) {
 ...
 * @returns 排序后的新数组
 */
export function sortHotspots(items, sortBy, sortOrder = 'desc') {
    const sorted = [...items];
...
//# sourceMappingURL=sortHotspots.js.map